    ...
    return (
        <>
            <nav className='flex items-center flex-wrap md:px-16 border-b-4' style={{ borderColor: '#ffba08', backgroundColor: '#0f1108' }}>
                <div className="w-screen grid grid-rows-1 md:grid-rows-1 grid-cols-8 md:grid-cols-5">
                    ...
                    <div className="hidden md:block col-span-3 font-heading grid grid-rows-1 grid-flow-col">
